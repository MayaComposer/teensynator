...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 598.20001220703125, 52.0, 29.0, 22.0 ],
					"text" : "r a6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 544.9000244140625, 52.0, 29.0, 22.0 ],
					"text" : "r a5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 492.20001220703125, 52.0, 29.0, 22.0 ],
					"text" : "r a4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 378.60003662109375, 52.0, 29.0, 22.0 ],
					"text" : "r a3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 865.0, 125.0, 59.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 865.0, 21.0, 150.0, 59.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 766.0, 372.0, 59.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 728.4000244140625, 454.79998779296875, 58.0, 22.0 ],
					"text" : "mute 1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 655.60003662109375, 454.79998779296875, 58.0, 22.0 ],
					"text" : "mute 0, 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 728.4000244140625, 502.79998779296875, 58.0, 22.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 655.60003662109375, 125.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.0, 620.0, 43.0, 22.0 ],
					"text" : "out~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 85.0, 52.0, 28.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 85.0, 550.4000244140625, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 489.70001220703125, 21.0, 160.399993896484375, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 874.5, 165.5, 501.70001220703125, 165.5 ],
					"order" : 2,
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 874.5, 165.5, 556.4000244140625, 165.5 ],
					"order" : 1,
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 874.5, 165.5, 607.70001220703125, 165.5 ],
					"order" : 0,
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.313725490196078, 0.615686274509804, 0.772549019607843, 1.0 ],
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 874.5, 165.5, 188.0, 165.5 ],
					"order" : 5,
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.313725490196078, 0.615686274509804, 0.772549019607843, 1.0 ],
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 874.5, 165.5, 282.5, 165.5 ],
					"order" : 4,
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.313725490196078, 0.615686274509804, 0.772549019607843, 1.0 ],
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 874.5, 165.5, 388.10003662109375, 165.5 ],
					"order" : 3,
					"source" : [ "obj-10", 0 ]
				}
